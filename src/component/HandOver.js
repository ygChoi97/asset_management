        ...
        reader.onload = () => {
            ...
            wb.xlsx.load(buffer).then(workbook => {
                ...
                workbook.eachSheet((sheet, id) => {
                    ...
                    strExcel = sheet.getRow(4).getCell(11).toString();  // 수량
                    strExcel = strExcel.replace(/\n/g, "");
                    strExcel = strExcel.replace(/\s*/g, "");
                    if (strDB !== strExcel) {
                        getConfirmationOK('해당 파일의 포맷은 import 불가합니다. 파일을 다시 선택해주세요.');
                    ...
                    for (let r = 7; r <= 14; r++) {
                        ...
                        if(r == 14) {
                            strDB = columns2[21].Header;
                            strDB = strDB.replace(/\n/g, "");
                            strDB = strDB.replace(/\s*/g, "");
                            let strExcel = sheet.getRow(18).getCell(15).toString();
                            strExcel = strExcel.replace(/\n/g, "");
                            strExcel = strExcel.replace(/\s*/g, "");
                            if (!strExcel.includes(strDB)) {
                                console.log(columns2[21].Header, ' : ', sheet.getRow(18).getCell(15).toString())
                                console.log(strDB, ' : ', strExcel)
                                getConfirmationOK(`해당 파일의 포맷은 import 불가합니다. 파일을 다시 선택해주세요. ${strDB}:${strExcel}`);
                                return;
                        }
                    ...
                    for (let r = 7; r <= 6 + Number(tempDbData[0]['quantity']); r++) {
                        ...
                        for (let r = 7; r <= 14; r++) {
                            ...
                            if(r == 14) {
                                let strSignificant = "";
                                str = sheet.getRow(14).getCell(16).toString();
                                str = str.replace(/\n/g, ""); // 개행문자 제거
                                str = str.trim();             // 양쪽 공백 제거
                                console.log(str)
                                strSignificant += `${str}`;
                                console.log(strSignificant)
                                str = sheet.getRow(15).getCell(15).toString();
                                str = str.replace(/\n/g, ""); // 개행문자 제거
                                str = str.trim();             // 양쪽 공백 제거
                                console.log(str)
                                if(str !== '')
                                ...
                                str = sheet.getRow(15).getCell(16).toString();
                                str = str.replace(/\n/g, ""); // 개행문자 제거
                                str = str.trim();             // 양쪽 공백 제거
                                ...
                                str = sheet.getRow(16).getCell(15).toString();
                                str = str.replace(/\n/g, ""); // 개행문자 제거
                                str = str.trim();             // 양쪽 공백 제거
                                ...
                                str = sheet.getRow(16).getCell(16).toString();
                                str = str.replace(/\n/g, ""); // 개행문자 제거
                                str = str.trim();             // 양쪽 공백 제거
                                ...
                                str = sheet.getRow(17).getCell(15).toString();
                                str = str.replace(/\n/g, ""); // 개행문자 제거
                                str = str.trim();             // 양쪽 공백 제거
                                ...
                                str = sheet.getRow(17).getCell(16).toString();
                                str = str.replace(/\n/g, ""); // 개행문자 제거
                                str = str.trim();             // 양쪽 공백 제거
                                ...
                                if (strSignificant === '_x000d_' || strSignificant === '')
                                    obj2[columns2[r + 6].accessor] = null;
                                else
                                    obj2[columns2[r + 6].accessor] = strSignificant;
                            
                                

                                str = sheet.getRow(18).getCell(16).toString();
                                str = str.replace(/\n/g, ""); // 개행문자 제거
                                str = str.trim();             // 양쪽 공백 제거
                                if (str === '_x000d_' || str === '')
                                    obj2[columns2[21].accessor] = null;
                                else
                                    obj2[columns2[21].accessor] = str;
                            }
