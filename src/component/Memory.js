...
const BASE_URL = `${API_BASE_URL}/api/memory`;
...
function Memory({ account }) {
    ...
    return (
        <>
            ...
            <TableMemory columns={columns} minCellWidth={50} data={data} classifications={classifications} areas={areas} dataWasFiltered={dataWasFiltered} doRefresh={doRefresh} account={account} />
        </>
