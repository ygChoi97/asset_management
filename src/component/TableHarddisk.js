...
function TableHarddisk({ columns, minCellWidth, data, classifications, areas, dataWasFiltered, doRefresh, account }) {
    ...
    return (
        <>
            ...
            <SearchHarddisk column1={'classification'} column2={'headquarters'} column3={'idasset'} column4={'area'} column5={'team'} column6={'manager'} column7={'application_date'} classifications={classifications}  areas={areas} onSubmit={setFilter} />
            {/* {searchs} */}
